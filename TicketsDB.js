const globoTickets = [
    {
        event: 'DJ Conference',
        image: require('./assets/images/dj1.jpg'),
        eventId: 'DJ-1',
        description: `DJ conference for those looking to get in the industry. Virtual due to the global situation. Sign up to be a part of all the excitement as vendors will be on hand to demo the latest gear`,
        shortDescription: 'A virtual DJ conference like no other',
        price: 20.00   
    },
    {
        event: 'Smart Guy',
        image: require('./assets/images/speaker1.jpg'),
        eventId: 'SG-1',
    ...
    },
    {
        ...
        image: require('./assets/images/guitarist1.jpg'),
        eventId: 'GT-1',
    ...
    },
    {
        ...
        image: require('./assets/images/speaker2.jpg'),
        eventId: 'BT-1',
    ...
    },
    {
        ...
        image: require('./assets/images/guitarist2.jpg'),
        eventId: 'AK-1',
